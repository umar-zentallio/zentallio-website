...
// Zentallio's Cal.com event type (30-min walkthrough/call, video). Serves both
// kinds by default; override per-env with the CALCOM_EVENT_* vars below.
const DEFAULT_EVENT_ID = "6503154";
